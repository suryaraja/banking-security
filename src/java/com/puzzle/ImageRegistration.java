 ...
 * @author Java
 */
public class ImageRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ImageRegistration</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ImageRegistration at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       System.err.println("Account"+Account);
        ...
        String TempUploadDirectory = "E:\\SoftwarePuzzle";
        ...
        TempUploadDirectory = "E:\\SoftwarePuzzle\\web";
        ...
        if (!(file2.exists())) {
         ...
         TempUploadDirectory = "E:\\SoftwarePuzzle\\web\\images";
        ...
        if (!(file3.exists())) {
         ...
         TempUploadDirectory = "E:\\SoftwarePuzzle\\web\\images\\puzzle";
               ...
               // String nn = "";
                ...
                for (FileItem item : multiparts) {
                    if (!item.isFormField()) {
                        ...
                        nn[count]=name;
                        System.out.println("name ==============="+count+"==="+nn[count]);
                        count++;
                    }
        ...
        try
        {
          ...
          String qr="update registration set captchaimage='"+nn[0]+"',puzzle ='"+nn[1]+"' where accno = '"+Account+"'";
          //update table emp set salary=2000 where empid=200"
           int count1 = st.executeUpdate(qr);
         if(count1>0)
            {
                 //session1.setAttribute("AccNo",Account);
           response.sendRedirect("RandomImage.jsp");
